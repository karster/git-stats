...
from lib.GitParser import GitParser
...
def main():
	...
	parser.add_argument('--keywords', help="Set path to file with keywords in json format", metavar="<path>")
	parser.add_argument('--result', help="Path to file", metavar="<path>")
